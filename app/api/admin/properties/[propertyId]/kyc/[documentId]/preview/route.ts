...
const rawGET = async function GET(_request: Request, { params }: RouteContext<"/api/admin/properties/[propertyId]/kyc/[documentId]/preview">) {
...
export const GET = withApiHandler(rawGET, { route: "/api/admin/properties/[propertyId]/kyc/[documentId]/preview", auth: "strict", requireAuth: true, cache: "private" });
