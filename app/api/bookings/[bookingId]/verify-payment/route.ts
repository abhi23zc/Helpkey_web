...
const rawPOST = async function POST(request: Request, { params }: RouteContext<"/api/bookings/[bookingId]/verify-payment">) {
...
export const POST = withApiHandler(rawPOST, { route: "/api/bookings/[bookingId]/verify-payment", auth: "strict", requireAuth: true, cache: "private" });
