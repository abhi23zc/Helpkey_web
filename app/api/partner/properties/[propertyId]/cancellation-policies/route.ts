...
const rawPOST = async function POST(request: Request, { params }: RouteContext<"/api/partner/properties/[propertyId]/cancellation-policies">) {
...
export const POST = withApiHandler(rawPOST, { route: "/api/partner/properties/[propertyId]/cancellation-policies", auth: "strict", requireAuth: true, cache: "private" });
